      ...
      <div className={styles.options}>
        <span className={styles.option}>
          ...
          <p>
            ...
            FACES CHALLENGES OF WATER CONSERVATION, INNOVATIVE APPROACHES LIKE
            WEB-BASED GAMES ARE GAINING ATTENTION. THESE GAMES OFTEN ADOPT
            ENGAGING AND EDUCATIONAL THEMES, SIMULATE REAL-WORLD WATER
            MANAGEMENT SCENARIOS, AND ENCOURAGE PLAYERS TO ADOPT SUSTAINABLE
            WATER-SAVING HABITS AND MINDFUL PRACTICES REGARDING ITS USE. THROUGH
            INTERACTIVE EXPERIENCES, GAMES CAN INSTILL A SENSE OF RESPONSIBILITY
            TOWARDS WATER CONSERVATION IN PLAYERS, ESPECIALLY THE YOUNGER
            GENERATION.
          </p>
          ...
          <p>
            WaterSense is a session-based maze arcade game where users can
            either take on the role of an educator to create game sessions and
            invite students to participate. Flo, the water-efficiency hero,
            embarks on a mission to save water by navigating through water pipes
            and answering questions about water conservation. However, it must
            avoid the Water Wasters—nasty monsters symbolizing bad water habits.
          </p>
            ...
            <ul className={styles.howTo}>
              ...
              <li>
                ...
                <ul style={{ listStyleType: "'* '" }}>
                  ...
                  <li>
                    Flo loses all three lives after being caught by Water
                    Wasters.
                  </li>
                  <li>
                    The final score will be added to a leaderboard, so you can
